...
#define nstates1	6	/* Centralita */
#define minseq1	13
#define maxseq1	17
#define endstate1	5

#define nstates0	14	/* Vecino */
#define minseq0	0
#define maxseq0	12
#define endstate0	13
...
#define Air2	(sizeof(P2) - Offsetof(P2, _6_2_i) - 1*sizeof(short))

#define PCentralita	((P1 *)this)
typedef struct P1 { /* Centralita */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 3; /* proctype */
	unsigned _p   : 5; /* state    */
#ifdef HAS_PRIORITY
...
#define PVecino	((P0 *)this)
typedef struct P0 { /* Vecino */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 3; /* proctype */
	unsigned _p   : 5; /* state    */
#ifdef HAS_PRIORITY
